...
public class ProductManager implements ProductService{
	...
	@Override
	public DataResult<List<Product>> getByProductNameContains(String product_name) {
		return new SuccessDataResult<List<Product>>
		(this.productDao.getByProductNameContains(product_name),"Data listelendi.");
	}

	@Override
	public DataResult<List<Product>> getByProductNameStartsWith(String product_name) {
		return new SuccessDataResult<List<Product>>
		(this.productDao.getByProductNameStartsWith(product_name),"Data listelendi.");
	}
